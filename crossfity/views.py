...
from crossfity.forms import AddAthleteUser, AthleteLogin
...
class AthleteLog(View):
    ...
    def get(self, request):
        form = AthleteLogin() # tworzymy instancję klasy 'Zadanie2Login' o nazwie form
        ...
        if form.is_valid():
            ...
            if user is not None:
                ...
                if next:
                    ...
                    return render(request, "crossfity/XXXXXXXXXXXXXX.html")
